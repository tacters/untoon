...
public class QaClss {
	...
	public QaClss(int qid, int cid, String qwriter, String qcontent, Date q_create_date, Date q_modify_date,
			String q_status) {
		super();
		this.qid = qid;
		this.cid = cid;
	...
	public String toString() {
		return "QaClss [qid=" + qid + ", cid=" + cid + ", qwriter=" + qwriter + ", qcontent=" + qcontent
