...
public class Ad implements java.io.Serializable {
	...
	public Ad(int adid, String ad_title, int ad_xy, Date ad_start, Date ad_end, String a_status, int ad_width,
			int ad_height, int ad_close, String ad_file, String ad_file_r) {
		super();
		this.adid = adid;
	...
	public String toString() {
		return "Ad [adid=" + adid + ", ad_title=" + ad_title + ", ad_xy=" + ad_xy + ", ad_start=" + ad_start
				...
				+ ad_height + ", ad_close=" + ad_close + ", ad_file=" + ad_file + ", ad_file_r=" + ad_file_r + "]";
	}
	...
	public String getAd_file_r() {
		return ad_file_r;
	}


	public void setAd_file_r(String ad_file_r) {
		this.ad_file_r = ad_file_r;
	}
