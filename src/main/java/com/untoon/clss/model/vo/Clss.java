...
public class Clss {
	...
	public Clss(int cid, String clss_title, int clss_price, Date clss_registration, Date clss_update,
			...
			String tchr_introduction, String tchr_profile, String clss_comment, String clss_tags, int save_count) {
		super();
		this.cid = cid;
	...
	public String toString() {
		return "Clss [cid=" + cid + ", clss_title=" + clss_title + ", clss_price=" + clss_price + ", clss_registration="
				...
				+ ", clss_comment=" + clss_comment + ", clss_tags=" + clss_tags + ", save_count=" + save_count + "]";
	}
