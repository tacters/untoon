...
<meta property="og:url"
	content="https://urbango.qodeinteractive.com/product-list/four-columns/" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Four Columns" />
<meta property="og:description"
	content="Sale Add to cart Italian Salad &#036;5 &#036;4 Sale Add to cart Espresso Coffee &#036;3 &#036;2 New Add to cart French Cheese &#036;50 New Add to cart Cowork Space &#036;800 Add to cart Italian Pasta &#036;5 Add to cart Chrono Pastry &#036;4 Sold Read more Cake And Sweets &#036;15 Add to cart Lemon Cocktails &#036;9 Add to cart Healthy Cereals [...]" />
<meta property="og:image" content="" />
<meta charset="UTF-8" />
<link rel="profile" href="https://gmpg.org/xfn/11" />
<meta name="viewport"
	content="width=device-width,initial-scale=1,user-scalable=yes">
<title>Four Columns &#8211; UrbanGo</title>
...
<link rel="stylesheet"
	href="https://urbango.qodeinteractive.com/wp-content/cache/minify/3b531.css"
	media="all" />
<link rel='stylesheet' id='rabbit_css-css'
	href='https://export.qodethemes.com/_toolbar/assets/css/rbt-modules.css?ver=5.5.1'
	type='text/css' media='all' />
<link rel="stylesheet"
	href="https://urbango.qodeinteractive.com/wp-content/cache/minify/c138f.css"
	media="all" />
...
<link rel="stylesheet"
	href="https://urbango.qodeinteractive.com/wp-content/cache/minify/9b7b5.css"
	media="all" />
...
<link rel="stylesheet"
	href="https://urbango.qodeinteractive.com/wp-content/cache/minify/8e8ad.css"
	media="all" />
<style id='urbango-edge-woo-inline-css' type='text/css'>
.page-id-553 .edgtf-content .edgtf-content-inner>.edgtf-container>.edgtf-container-inner,
	.page-id-553 .edgtf-content .edgtf-content-inner>.edgtf-full-width>.edgtf-full-width-inner
	{
...
<link rel="stylesheet"
	href="https://urbango.qodeinteractive.com/wp-content/cache/minify/ebd5f.css"
	media="all" />
<link rel='stylesheet' id='urbango-edge-google-fonts-css'
	...
	type='text/css' media='all' />
<!--[if lt IE 9]>
<link rel='stylesheet' id='vc_lte_ie9-css'  href='https://urbango.qodeinteractive.com/wp-content/plugins/js_composer/assets/css/vc_lte_ie9.min.css' type='text/css' media='screen' />
<![endif]-->
<link rel="stylesheet"
	href="https://urbango.qodeinteractive.com/wp-content/cache/minify/82aae.css"
	media="all" />
<script type='text/javascript'
...
<link rel="alternate" type="application/json"
	href="https://urbango.qodeinteractive.com/wp-json/wp/v2/pages/553" />
...
<link rel='shortlink' href='https://urbango.qodeinteractive.com/?p=553' />
<link rel="alternate" type="application/json+oembed"
	href="https://urbango.qodeinteractive.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Furbango.qodeinteractive.com%2Fproduct-list%2Ffour-columns%2F" />
<link rel="alternate" type="text/xml+oembed"
	href="https://urbango.qodeinteractive.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Furbango.qodeinteractive.com%2Fproduct-list%2Ffour-columns%2F&#038;format=xml" />
...
<body
								...
								<nav class="edgtf-main-menu edgtf-drop-down edgtf-default-nav">
									<ul id="menu-main-menu-navigation" class="clearfix">
										<li id="nav-menu-item-36"
											class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home  narrow"><a
											href="https://urbango.qodeinteractive.com/" class=""><span
										...
										<li id="nav-menu-item-38"
											class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children edgtf-active-item has_sub narrow"><a
											href="#" class=" current  no_link"
											onclick="JavaScript: return false;"><span
												...
												<div class="inner">
													<ul>
														<li id="nav-menu-item-559"
															class="menu-item menu-item-type-post_type menu-item-object-page current-page-ancestor current-page-parent "><a
														...
														<li id="nav-menu-item-564"
															class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children sub"><a
															href="#" class=" no_link"
															onclick="JavaScript: return false;"><span
															...
															<ul>
																...
																<li id="nav-menu-item-560"
																	class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-553 current_page_item "><a
																	href="https://urbango.qodeinteractive.com/product-list/four-columns/"
																	class=""><span class="item_outer"><span
									...
									<nav class="edgtf-main-menu edgtf-drop-down edgtf-sticky-nav">
										<ul id="menu-main-menu-navigation-1" class="clearfix">
											<li id="sticky-nav-menu-item-36"
												class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home  narrow"><a
												href="https://urbango.qodeinteractive.com/" class=""><span
													class="item_outer"><span class="item_text">Home</span><span
						...
						<div class="edgtf-grid">
							<ul id="menu-main-menu-navigation-2" class="">
								<li id="mobile-menu-item-36"
									...
									href="https://urbango.qodeinteractive.com/" class=""><span>Home</span></a></li>
								...
								<li id="mobile-menu-item-38"
									class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children edgtf-active-item has_sub"><h6>
										<span>Shop</span>
									</h6>
									<span class="mobile_arrow"><i
										class="edgtf-sub-arrow arrow_carrot-right"></i><i
									...
									<ul class="sub_menu">
										...
										<li id="mobile-menu-item-564"
											class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children  has_sub"><h6>
			...
			<div class="edgtf-content">
				<div class="edgtf-content-inner">
					<div
						...
						style="height: 375px; background-image: url(https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-title-img-1.jpg);"
						data-height="375">
						<div class="edgtf-title-image">
							<img itemprop="image"
								src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-title-img-1.jpg"
								alt="a" />
						</div>
						...
						<div class="edgtf-title-wrapper" style="height: 375px">
							<div class="edgtf-title-inner">
								<div class="edgtf-grid">
									<h2 class="edgtf-page-title entry-title" style="color: #ffffff">가영이 페이지</h2>
								</div>
							</div>
						</div>
												...
												<div class="wpb_column vc_column_container vc_col-sm-12">
													<div class="vc_column-inner">
														<div class="wpb_wrapper">
															<div
																class="edgtf-pl-holder edgtf-grid-list edgtf-disable-bottom-space edgtf-standard-layout edgtf-four-columns edgtf-normal-space edgtf-info-below-image ">
																<div class="edgtf-pl-outer edgtf-outer-space">
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<span class="edgtf-pli-onsale">Sale</span> <img
																					width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-1-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-1.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-1-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-1-768x864.jpg 768w"
																				...
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							...
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=477"
																								data-quantity="1" data-product_id="477"
																								data-product_sku="01"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																					</div>
																				</div>
																			</div>
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/italian-salad/"
																				title="Italian Salad"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/italian-salad/">Italian
																					Salad</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				<del>
																					<span class="woocommerce-Price-amount amount"><span
																						class="woocommerce-Price-currencySymbol">&#036;</span>5</span>
																				</del>
																				<ins>
																					<span class="woocommerce-Price-amount amount"><span
																						class="woocommerce-Price-currencySymbol">&#036;</span>4</span>
																				</ins>
																			</div>
																		</div>
																	</div>
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<span class="edgtf-pli-onsale">Sale</span> <img
																					width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-2-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-2.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-2-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-2-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=483"
																								data-quantity="1" data-product_id="483"
																								data-product_sku="02"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/espresso-coffee/"
																				title="Espresso Coffee"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/espresso-coffee/">Espresso
																					Coffee</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				<del>
																					<span class="woocommerce-Price-amount amount"><span
																						class="woocommerce-Price-currencySymbol">&#036;</span>3</span>
																				</del>
																				<ins>
																					<span class="woocommerce-Price-amount amount"><span
																						class="woocommerce-Price-currencySymbol">&#036;</span>2</span>
																				</ins>
																			</div>
																		</div>
																	</div>
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<span class="edgtf-pli-new-product">New</span> <img
																					width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-3-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-3.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-3-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-3-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=485"
																								data-quantity="1" data-product_id="485"
																								data-product_sku="03"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/french-cheese/"
																				title="French Cheese"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/french-cheese/">French
																					Cheese</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				<span class="woocommerce-Price-amount amount"><span
																					class="woocommerce-Price-currencySymbol">&#036;</span>50</span>
																			</div>
																		</div>
																	</div>
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<span class="edgtf-pli-new-product">New</span> <img
																					width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-4-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-4.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-4-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-4-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=487"
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/cowork-space/"
																				title="Cowork Space"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/cowork-space/">Cowork
																					Space</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				<span class="woocommerce-Price-amount amount"><span
																					class="woocommerce-Price-currencySymbol">&#036;</span>800</span>
																			</div>
																		</div>
																	</div>
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<img width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-5-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-5.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-5-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-5-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=489"
																								data-quantity="1" data-product_id="489"
																								data-product_sku="05"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/italian-pasta/"
																				title="Italian Pasta"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/italian-pasta/">Italian
																					Pasta</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																	...
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<img width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-6-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-6.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-6-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-6-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=491"
																								data-quantity="1" data-product_id="491"
																								data-product_sku="06"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/chrono-pastry/"
																				title="Chrono Pastry"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/chrono-pastry/">Chrono
																					Pastry</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																	...
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<span class="edgtf-pli-out-of-stock">Sold</span> <img
																					width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-7-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-7.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-7-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-7-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="https://urbango.qodeinteractive.com/product/cake-and-sweets/"
																								data-quantity="1" data-product_id="493"
																								data-product_sku="07"
																								class="button ajax_add_to_cart edgtf-button">Read
																								more</a>
																						</div>
																					</div>
																				</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/cake-and-sweets/"
																				title="Cake And Sweets"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/cake-and-sweets/">Cake
																					And Sweets</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																	...
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<img width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-8-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-8.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-8-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-8-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=495"
																								data-quantity="1" data-product_id="495"
																								data-product_sku="08"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/lemon-cocktails/"
																				title="Lemon Cocktails"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/lemon-cocktails/">Lemon
																					Cocktails</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				<span class="woocommerce-Price-amount amount"><span
																					class="woocommerce-Price-currencySymbol">&#036;</span>9</span>
																			</div>
																		</div>
																	</div>
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<img width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-9-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-9.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-9-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-9-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=497"
																								data-quantity="1" data-product_id="497"
																								data-product_sku="09"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/healthy-cereals/"
																				title="Healthy Cereals"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/healthy-cereals/">Healthy
																					Cereals</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				<span class="woocommerce-Price-amount amount"><span
																					class="woocommerce-Price-currencySymbol">&#036;</span>7</span>
																			</div>
																		</div>
																	</div>
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<img width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-10-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-10.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-10-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-10-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=500"
																								data-quantity="1" data-product_id="500"
																								data-product_sku="010"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																					</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/casual-outfits/"
																				title="Casual Outfits"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/casual-outfits/">Casual
																					Outfits</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				<span class="woocommerce-Price-amount amount"><span
																					class="woocommerce-Price-currencySymbol">&#036;</span>20</span>
																			</div>
																		</div>
																	</div>
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<img width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-11-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-11.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-11-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-11-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=506"
																								data-quantity="1" data-product_id="506"
																								data-product_sku="011"
																								class="button add_to_cart_button ajax_add_to_cart edgtf-button">Add
																								to cart</a>
																						</div>
																					</div>
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/chocolate/"
																				title="Chocolate"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/chocolate/">Chocolate</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																					title="Rated %s out of 5">
																	...
																	<div class="edgtf-pli edgtf-item-space ">
																		<div class="edgtf-pli-inner">
																			<div class="edgtf-pli-image">
																				<span class="edgtf-pli-onsale">Sale</span> <img
																					width="800" height="900"
																					src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-12-800x900.jpg"
																					class="attachment-woocommerce_single size-woocommerce_single wp-post-image"
																					alt="a" loading="lazy"
																					srcset="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-12.jpg 800w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-12-267x300.jpg 267w, https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/shop-img-12-768x864.jpg 768w"
																					sizes="(max-width: 800px) 100vw, 800px" />
																			</div>
																			<div class="edgtf-pli-text">
																				<div class="edgtf-pli-text-outer">
																					<div class="edgtf-pli-text-inner">
																						<div
																							class="edgtf-pli-add-to-cart edgtf-default-skin">
																							<a rel="nofollow"
																								href="/product-list/four-columns/?add-to-cart=508"
																			...
																			<a class="edgtf-pli-link" itemprop="url"
																				href="https://urbango.qodeinteractive.com/product/yoga-lessons/"
																				title="Yoga Lessons"></a>
																		</div>
																		<div class="edgtf-pli-text-wrapper">
																			<h4 itemprop="name"
																				class="entry-title edgtf-pli-title">
																				<a itemprop="url"
																					href="https://urbango.qodeinteractive.com/product/yoga-lessons/">Yoga
																					Lessons</a>
																			</h4>
																			<div class="edgtf-pli-rating-holder">
																				<div class="edgtf-pli-rating"
																			...
																			<div class="edgtf-pli-price">
																				...
																				<ins>
																					<span class="woocommerce-Price-amount amount"><span
																						class="woocommerce-Price-currencySymbol">&#036;</span>40</span>
																				</ins>
																			</div>
																		</div>
																	</div>
						...
						<div
							...
							<div class="edgtf-column-content edgtf-grid-col-3">
								...
								<div class="widget edgtf-custom-font-widget">
									<p class="edgtf-custom-font-holder  edgtf-cf-6826  "
										style="margin: 10px 50px 0 0" data-item-class="edgtf-cf-6826">
							...
							<div class="edgtf-column-content edgtf-grid-col-3">
									...
									<div class="textwidget">
										<p>
											<a
												...
												href="/cdn-cgi/l/email-protection#1f4a6d7d7e7158705f6e707b7a76716b7a6d7e7c6b76697a317c7072">
												<span class="__cf_email__"
												data-cfemail="b1e4c3d3d0dff6def1c0ded5d4d8dfc5d4c3d0d2c5d8c7d49fd2dedc">[email&#160;protected]</span>
											</a>
										</p>
									</div>
								</div>
								<div class="widget edgtf-contact-form-7-widget ">
									<div role="form" class="wpcf7" id="wpcf7-f5-o1" lang="en-US"
										...
										<form action="/product-list/four-columns/#wpcf7-f5-o1"
											method="post" class="wpcf7-form init cf7_custom_style_2"
				...
				<div class="edgtf-wp-section-holder edgtf-wp-login-holder">
					...
					<div class="edgtf-social-login-holder">
							...
							<fieldset>
								...
								<div class="edgtf-wp-section-button edgtf-login-button-holder">
									...
									<input type="hidden" id="edgtf-login-security"
										...
										value="/product-list/four-columns/" />
								</div>
						...
						<div class="edgtf-login-form-social-login">
							...
							<div class="edgtf-login-social-networks">
								<form class="edgtf-facebook-login-holder">
									<input type="hidden" id="edgtf_nonce_facebook_login_2099307514"
										name="edgtf_nonce_facebook_login_2099307514"
										value="7cc89bccf7" /><input type="hidden"
										name="_wp_http_referer" value="/product-list/four-columns/" />
									<button type="submit"
								...
								<form class="edgtf-google-login-holder">
									<input type="hidden" id="edgtf_nonce_google_login_1512706673"
										name="edgtf_nonce_google_login_1512706673" value="ea2c19a958" /><input
										type="hidden" name="_wp_http_referer"
										value="/product-list/four-columns/" />
									<button type="submit"
						...
						<script type="text/template"
							class="edgtf-membership-response-template">
				</script>
					</div>
				</div>
			</div>
				...
				<div class="edgtf-wp-section-holder edgtf-wp-register-holder">
					...
					<div class="edgtf-social-register-holder">
						<form method="post" class="edgtf-register-form">
							<fieldset>
								<div>
									<input type="text" name="user_register_name"
										id="user_register_name" placeholder="User Name" value=""
										required pattern=".{3,}" title="Three or more characters" />
								</div>
								<div>
									<input type="email" name="user_register_email"
										id="user_register_email" placeholder="Email" value="" required />
								</div>
								<div>
									<input type="password" name="user_register_password"
										id="user_register_password" placeholder="Password" value=""
										required />
								</div>
								<div>
									<input type="password" name="user_register_confirm_password"
										id="user_register_confirm_password"
										placeholder="Repeat Password" value="" required />
								</div>
								<input type="hidden" id="user_register_role"
									name="user_register_role" value="owner">
								<div
									class="edgtf-wp-section-button edgtf-register-button-holder">
									<button type="submit"
										class="edgtf-btn edgtf-btn-medium edgtf-btn-solid">
										<span class="edgtf-btn-text">Register</span>
									</button>
									<input type="hidden" id="edgtf-register-security"
										name="edgtf-register-security" value="eda66d137b" /><input
										type="hidden" name="_wp_http_referer"
										value="/product-list/four-columns/" />
								</div>
							</fieldset>
						...
						<p class="edgtf-wp-section-notice">
							<span>Have an account?</span> <a class="edgtf-wp-login-button"
								href="#">Log in</a>
						</p>
						<div class="edgtf-membership-response-holder clearfix"></div>
						<script type="text/template"
			...
			<div class="edgtf-forgot-pass-content-inner">
				<div class="edgtf-wp-section-holder edgtf-wp-forgot-pass-holder">
					...
					<div class="edgtf-social-reset-password-holder">
						<form
							action="https://urbango.qodeinteractive.com/wp-login.php?action=lostpassword"
							method="post" id="edgtf-lost-password-form"
							class="edgtf-reset-pass-form">
							<div>
								<input type="text" name="user_reset_password_login"
									class="edgtf-input-field" id="user_reset_password_login"
									placeholder="Username or Email Address *" value="" size="20"
									required>
							</div>
							<div class="edgtf-reset-password-button-holder">
								<button type="submit"
									class="edgtf-btn edgtf-btn-medium edgtf-btn-solid">
									<span class="edgtf-btn-text">GET NEW PASSWORD</span>
								</button>
							</div>
						</form>
						<div class="edgtf-membership-response-holder clearfix"></div>
	...
	<noscript>
		<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5T772QJ"
