...
<script type="text/javascript">
 $(function(){
        ...
        IMP.request_pay({
            ...
            name : '[언투온]${clss.clss_title}',
            amount : '${ clss.clss_price }',
            buyer_email : '',
            buyer_name : '',
            buyer_tel : '',
            buyer_addr : '',
            ...
            m_redirect_url :  'http://www.iamport.kr/mobile/landing'
            	// 결제 완료 후 보낼 컨트롤러의 메소드명  'http://www.iamport.kr/mobile/landing'
        }, function(rsp) {
            if ( rsp.success ) {
                ...
                jQuery.ajax({
                    url: <%=request.getContextPath()%> + "/pinsert.do", //cross-domain error가 발생하지 않도록 주의해주세요
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        imp_uid : rsp.imp_uid,
